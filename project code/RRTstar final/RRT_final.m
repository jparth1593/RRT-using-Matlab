...
while i <= iterations
   ...
   %plot([vertecies(ind_nearest(i),1),vertecies(vert_count+1,1)],[vertecies(ind_nearest(i),2),vertecies(vert_count+1,2)],'LineWidth',0.1,'Color','k');
   %line(finaltree(:,1),finaltree(:,2),'LineWidth',1,'Color','r');
    %line(finaltree(:,1),finaltree(:,2),'LineWidth',0.5,'color','k');
...
line(edges.x', edges.y','LineWidth',0.1,'Color','k');
line(finaltree(:,1),finaltree(:,2),'LineWidth',1,'Color','r');
